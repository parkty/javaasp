...
3. 확장성(Scalability)
  * 관련 기술:
	...
	* 오토스케일링 (AWS Aut	* Scaling, Kubernetes Horizontal Pod Autoscaler)
...
5. 투명성(Transparency)
  ...
  * 고려사항:
	...
	* 서비스 간 통신에서 위치나 장애의 투명성을 확보하기 위한 리다이렉션 및 복구 메
커니즘
...
8. 분산 데이터 관리
  ...
  * 고려사항:
	* CAP 이론에 따른 일관성(Consistency), 가용성(Availability), 파티션 허용성(Partition
Tolerance) 간의 트레이드오프
...
![3 적용기술(확장)_Sample2](https://github.com/user-attachments/assets/b5c6ad6f-d4d7-4967-ae6a-55fe0ab904a0)
